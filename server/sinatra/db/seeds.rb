...
questions_data = [
  ...
  { question: '¿Cuál es la capital de China?', correct_option: 'Beijing', topic: 'Capitales', exam_name: 'Exam Capitales 1' },
...
materials_data = [
  ...
  { content: 'Beijing es la capital de China.', topic: 'Capitales', level: 'Nivel Capitales 1' },
